    ...
    return (
        <div style={{ marginTop: '120px' }}>
            ...
            <form className="max-w-sm mx-auto">
                ...
                {/* Submit button */}
                <button onClick={signIn} type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base w-full sm:w-auto px-20 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mx-auto block">Sign Up</button>

                {/* Login link */}
                <p className="text-center" style={{marginTop: '7px'}}>do you have an account? <a href="/login" className="text-blue-700 hover:text-blue-800 dark:text-blue-500 dark:hover:text-blue-400">Sign In</a></p>

                {/* Google button */}
                <button onClick={signInGoogle} type="button" className="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-20 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2 mx-auto block" style = {{marginLeft: '35px', marginTop: '30px'}}>
